...
with open('config.json') as json_file:
    ...
    base_contrast = int(float( data["contrast"]) )
...
font_time        =  ImageFont.truetype(font_folder_path+"/msyh.ttf", 15)
font_awesome     =  ImageFont.truetype(font_folder_path+"/fontawesome-webfont.ttf", 14)
font_icons       =  ImageFont.truetype(font_folder_path+"/icons.ttf", 14)
font_big_icons   =  ImageFont.truetype(font_folder_path+"/icons.ttf", 30)
font_32   =  ImageFont.truetype(font_folder_path+"/arial.ttf", 30)
font_55  =  ImageFont.truetype(font_folder_path+"/arial.ttf", 55)
